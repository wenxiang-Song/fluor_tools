...
def load_data_with_fp(data, fp_data, name, load):
    dataset = MoleculeCSVDataset(data,
                                ...
                                #  cache_file_path=str(name)+'_dataset_abs.bin',
                                 cache_file_path = os.path.join('./predict', f'{name}_dataset_abs.bin'),
                                 task_names=['abs'],
...
#数据加载
train_data = pd.read_csv('./predict/data/train_abs.csv')
valid_data = pd.read_csv('./predict/data/valid_abs.csv')
...
train_fp_solvent = load_fingerprints('./predict/data/train_sol_abs.csv')
valid_fp_solvent = load_fingerprints('./predict/data/valid_sol_abs.csv')
train_fp_smiles = load_fingerprints('./predict/data/train_smiles_abs.csv')
valid_fp_smiles = load_fingerprints('./predict/data/valid_smiles_abs.csv')
...
# === 读取 target 数据 ===
target_data = pd.read_csv('./predict/input/input.csv')
target_fp_solvent = load_fingerprints('./predict/input/target_sol_morgan.csv')
target_fp_smiles = load_fingerprints('./predict/input/target_smiles_morgan.csv')
...
# 加载保存的模型参数
model.load_state_dict(torch.load('./predict/data/model/Model_abs.pth', map_location=device))
model.eval()
...
target_scale_predictions = np.round(target_scale_predictions, 2)

# === 保存预测结果 ===
save_predictions(target_scale_predictions, './predict/result/target_predictions_abs.csv')
...
def load_data_with_fp(data, fp_data, name, load):
    dataset = MoleculeCSVDataset(data,
                                ...
                                cache_file_path = os.path.join('./predict', f'{name}_dataset_em.bin'),
                                 task_names=['em'],
                                 load=load, init_mask=True, n_jobs=1)
...
#数据加载
train_data = pd.read_csv('./predict/data/train_em.csv')
valid_data = pd.read_csv('./predict/data/valid_em.csv')
...
train_fp_solvent = load_fingerprints('./predict/data/train_sol_em.csv')
valid_fp_solvent = load_fingerprints('./predict/data/valid_sol_em.csv')
train_fp_smiles = load_fingerprints('./predict/data/train_smiles_em.csv')
valid_fp_smiles = load_fingerprints('./predict/data/valid_smiles_em.csv')
...
# 加载保存的模型参数
model.load_state_dict(torch.load('./predict/data/model/Model_em.pth', map_location=device))
model.eval()
...
# === 保存预测结果 ===
save_predictions(target_scale_predictions, './predict/result/target_predictions_em.csv')
...
def load_data_with_fp(data, fp_data, name, load):
    dataset = MoleculeCSVDataset(data,
                                ...
                                cache_file_path = os.path.join('./predict', f'{name}_dataset_plqy.bin'),
                                 task_names=['plqy'],
                                 load=load, init_mask=True, n_jobs=1)
...
train_data = pd.read_csv('./predict/data/train_plqy.csv')
valid_data = pd.read_csv('./predict/data/valid_plqy.csv')

scaler = StandardScaler()
train_data[['plqy']] = scaler.fit_transform(train_data[['plqy']])
valid_data[['plqy']] = scaler.transform(valid_data[['plqy']])

train_fp_solvent = load_fingerprints('./predict/data/train_sol_plqy.csv')
valid_fp_solvent = load_fingerprints('./predict/data/valid_sol_plqy.csv')
train_fp_smiles = load_fingerprints('./predict/data/train_smiles_plqy.csv')
valid_fp_smiles = load_fingerprints('./predict/data/valid_smiles_plqy.csv')
...
# 加载保存的模型参数
model.load_state_dict(torch.load('./predict/data/model/Model_plqy.pth', map_location=device))
model.eval()
...
# === 保存预测结果 ===
save_predictions(target_scale_predictions, './predict/result/target_predictions_plqy.csv')
...
def load_data_with_fp(data, fp_data, name, load):
    dataset = MoleculeCSVDataset(data,
                                ...
                                cache_file_path = os.path.join('./predict', f'{name}_dataset_k.bin'),
                                 task_names=['k'],
                                 load=load, init_mask=True, n_jobs=1)
...
train_data = pd.read_csv('./predict/data/train_k.csv')
valid_data = pd.read_csv('./predict/data/valid_k.csv')

scaler = StandardScaler()
train_data[['k']] = scaler.fit_transform(train_data[['k']])
valid_data[['k']] = scaler.transform(valid_data[['k']])

train_fp_solvent = load_fingerprints('./predict/data/train_sol_k.csv')
valid_fp_solvent = load_fingerprints('./predict/data/valid_sol_k.csv')
train_fp_smiles = load_fingerprints('./predict/data/train_smiles_k.csv')
valid_fp_smiles = load_fingerprints('./predict/data/valid_smiles_k.csv')
...
# === 标签标准化（只为保持接口一致，其实预测时不需操作标签） ===
target_data[['k']] = scaler.transform(target_data[['k']])  # 注意：仅为构造 dataset，不影响预测结果
...
# 加载保存的模型参数
model.load_state_dict(torch.load('./predict/data/model/Model_k.pth', map_location=device))
model.eval()
...
# === 保存预测结果 ===
save_predictions(target_scale_predictions, './predict/result/target_predictions_k.csv')
